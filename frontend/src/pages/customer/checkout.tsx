        ...
        <div className="mx-auto w-full max-w-2xl px-4 pt-10 pb-16">
          <div className="glass p-10 text-center">
            ...
            <Link
              ...
              className="btn-neon mt-5 inline-flex px-5 py-2.5 text-sm"
            >
              Browse products
            </Link>
          </div>
            ...
            <section className="glass p-6">
              ...
              <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-3">
                {[
                  ...
                  <label
                    key={m.name}
                    className="cursor-pointer block rounded-2xl border border-ink/10 bg-white/60 p-4 text-sm transition has-[input:checked]:border-neon has-[input:checked]:bg-white"
                  >
          ...
          <aside className="lg:col-span-2">
            <div className="glass p-6">
              ...
              <div className="mt-5 relative aspect-[1.6/1] overflow-hidden rounded-3xl bg-gradient-to-br from-[#0F172A] via-[#1E293B] to-[#0B1220] p-5 text-white shadow-xl">
                ...
                <div className="mt-10 font-display text-xl tracking-[0.25em]">
                  4242 4242 4242 4242
                </div>
              ...
              <div className="mt-5 border-t border-ink/10 pt-4 space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-ink">{shipping === 0 ? "Free" : `$${shipping}`}</span>
                </div>
                <div className="flex justify-between">
