      ...
      <div className="mx-auto w-full max-w-[1400px] px-4 pt-6 pb-16">
        ...
        {items.length === 0 ? (
          <div className="glass mt-6 p-10 text-center">
            ...
            <Link href={ROUTES.CATEGORIES} className="btn-neon mt-4 inline-flex px-5 py-2 text-sm">
              Shop now
            </Link>
          </div>
        ) : (
          <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            <aside className="glass h-fit p-6">
              ...
              <Link
                ...
                className="mt-3 block text-center text-xs text-ink-soft hover:text-ink"
              >
                Continue shopping
              </Link>
            </aside>
